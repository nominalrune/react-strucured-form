export default function TextareaInput({ name, value, className, onChange,underlineStyle, defaultValue, ...rest }: { name: string, value: string, className?: string, onChange: (e: React.ChangeEvent<HTMLTextAreaElement>) => void, underlineStyle?:boolean }) {
