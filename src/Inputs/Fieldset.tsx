...
export default function Fieldset({ label, children, overflowScroll = true, className }: FieldsetProps) {
    return <fieldset className={`group/fieldset p-0 m-0 mt-3 rounded-md relative ${overflowScroll ? "after:w-full after:h-full after:block after:absolute after:z-50 after:content-[''] after:pointer-events-none after:top-0 after:shadow-inset-vertical after:shadow-slate-200":""} ${className ?? ""}`}>
